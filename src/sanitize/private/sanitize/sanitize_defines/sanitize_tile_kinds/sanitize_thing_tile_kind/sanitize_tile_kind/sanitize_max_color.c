...
/*                                                                            */
/*                                                        ::::::::            */
/*   sanitize_max_color.c                               :+:    :+:            */
/*                                                     +:+                    */
/*   By: sbos <sbos@student.codam.nl>                 +#+                     */
/*                                                   +#+                      */
/*   Created: 2022/08/03 14:55:56 by sbos          #+#    #+#                 */
/*   Updated: 2022/08/12 11:34:04 by sbos          ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
				...
				t_tile_kind_color tile_kind_data_color, t_data *data)
{
	...
	while (sl_iterate_rgb_channel_indices(&it, data) != FINISHED)
	{
		...
		if (tile_kind_data_color.max_color[channel] < \
			tile_kind_data_color.initial_color[channel])
			return (sl_set_error(SL_ERROR_TOO_LOW_MAX_COLOR));
	}
	return (OK);
}
