...
/*   Updated: 2022/08/04 14:13:27 by sbos          ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
t_controls	get_player_controls(t_u8 character)
{
	...
	[PLAYER_1_CHARACTER] = {.movement_keys = {PLAYER_1_UP_KEY,
		PLAYER_1_DOWN_KEY, PLAYER_1_LEFT_KEY, PLAYER_1_RIGHT_KEY}},
	[PLAYER_2_CHARACTER] = {.movement_keys = {PLAYER_2_UP_KEY,
		PLAYER_2_DOWN_KEY, PLAYER_2_LEFT_KEY, PLAYER_2_RIGHT_KEY}},
	};
